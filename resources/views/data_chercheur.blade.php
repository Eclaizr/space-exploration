...
<div class="container">
    ...
    <p> <img src="../images/information.png" alt="Logo information" class="logo-information"> Pour plus d'informations sur le degré d'habitabilité d'une planète: <a href="https://fr.wikipedia.org/wiki/Indice_de_similarit%C3%A9_avec_la_Terre">cliquez ici</a><br></p>
    ...
    <!-- 5) Objets Découverts -->
    <h2>Objets célestes découverts <a href="/formObjetDecouvert" class="nav-button">Ajouter</a></h2>
        ...
        $('#missionsNonHabiteesTable').DataTable({
            ...
            initComplete: function () {
                $('select').each(function() {
                    $(this).val($(this).find('option:first').val()); // Sélectionne la première option
                });
            }
        });
